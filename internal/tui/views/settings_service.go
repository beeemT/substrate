	...
	sections := []SettingsSection{
		...
		},
		{
			...
			Fields: []SettingsField{
				...
				{Section: "adapters.gitlab", Key: "issue_comment_scope", Label: "Issue Action Scope", Type: SettingsFieldEnum, Value: string(cfg.Adapters.GitLab.IssueActionScope), Options: []string{"all", "mine", "none"}},
				{Section: "adapters.gitlab", Key: "assignee", Label: "Assignee", Type: SettingsFieldString, Value: cfg.Adapters.GitLab.Assignee, Description: "Username to assign issues to. Defaults to \"me\"."},
				{Section: "adapters.gitlab", Key: "in_progress_status", Label: "In Progress Status", Type: SettingsFieldString, Value: cfg.Adapters.GitLab.InProgressStatus, Description: "GitLab Work Item status name to set on plan approval (requires GraphQL). Leave empty to skip."},
			},
		},
		{
			ID:          "provider.sentry",
		...
		},
		{
			...
			Fields: []SettingsField{
				...
				{Section: "adapters.github", Key: "issue_comment_scope", Label: "Issue Action Scope", Type: SettingsFieldEnum, Value: string(cfg.Adapters.GitHub.IssueActionScope), Options: []string{"all", "mine", "none"}},
				{Section: "adapters.github", Key: "assignee", Label: "Assignee", Type: SettingsFieldString, Value: cfg.Adapters.GitHub.Assignee, Description: "Username to assign issues to. Defaults to \"me\"."},
				{Section: "adapters.github", Key: "in_progress_status", Label: "In Progress Status", Type: SettingsFieldString, Value: cfg.Adapters.GitHub.InProgressStatus, Description: "GitHub issue label to apply on plan approval. Leave empty to skip."},
...
func applyField(cfg *config.Config, field SettingsField) error {
	...
	case "adapters.gitlab.issue_comment_scope":
		cfg.Adapters.GitLab.IssueActionScope = config.IssueActionScope(value)
	case "adapters.gitlab.in_progress_status":
		cfg.Adapters.GitLab.InProgressStatus = value
	...
	case "adapters.github.issue_comment_scope":
		cfg.Adapters.GitHub.IssueActionScope = config.IssueActionScope(value)
	case "adapters.github.in_progress_status":
		cfg.Adapters.GitHub.InProgressStatus = value
...
func fieldPresentation(section, key string) (description string, defaultValue string) {
	...
	case "adapters.github.in_progress_status":
		return "GitHub issue label to apply on plan approval.", statusEmpty
	case "adapters.github.reviewers":
