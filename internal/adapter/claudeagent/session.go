...
type claudeAgentSession struct {
	...
	logDir          string
	workDir         string
	claudeSessionID string // Claude SDK session UUID for resume
...
func (s *claudeAgentSession) closeEvents() {
	s.closeOnce.Do(func() {
		close(s.events)
	})
}
...
func (s *claudeAgentSession) ID() string {
	return s.id
}
...
func (s *claudeAgentSession) Wait(ctx context.Context) error {
...
func (s *claudeAgentSession) Events() <-chan adapter.AgentEvent {
	return s.events
}

// SendMessage sends a message to the running agent.
// Used for foreman iteration and critique feedback.
func (s *claudeAgentSession) SendMessage(_ context.Context, msg string) error {
	return s.sendMessage(msg)
}

// Steer sends a steering prompt that interrupts the agent's active streaming turn.
func (s *claudeAgentSession) Steer(_ context.Context, msg string) error {
	return s.sendSteer(msg)
}

// Abort terminates the agent session gracefully.
func (s *claudeAgentSession) Abort(_ context.Context) error {
	s.mu.Lock()
	if s.aborted {
		s.mu.Unlock()
...
func (s *claudeAgentSession) sendPrompt(text string) error {
...
func (s *claudeAgentSession) sendMessage(text string) error {
...
func (s *claudeAgentSession) sendSteer(text string) error {
...
func (s *claudeAgentSession) SendAnswer(_ context.Context, answer string) error {
...
func (s *claudeAgentSession) readEvents() {
...
func (s *claudeAgentSession) mapBridgeEvent(raw struct {
	Type  string          `json:"type"`
	Event json.RawMessage `json:"event"`
},
...
func (s *claudeAgentSession) readStderr() {
...
func (s *claudeAgentSession) rotateLogLocked() {
	if s.logFile == nil {
		return
	}
